...
import { Camera, MessageSquare, BookOpen, TrendingUp, Users, Sparkles, ArrowRight, Star, Zap, Scan, Heart } from "lucide-react";
...
const features = [
  {
    name: "EyeRead",
    description: "Baca buku dengan kamera pintar menggunakan teknologi OCR canggih.",
    icon: Camera,
  ...
  {
    name: "NeoTutor",
    description: "Guru AI pribadi yang siap membantu 24/7.",
    icon: MessageSquare,
  ...
  {
    name: "Flexa",
    description: "Konversi materi ke format aksesibel.",
    icon: BookOpen,
    colSpan: "md:col-span-4",
  ...
  {
    name: "Pathly",
    description: "Jalur belajar adaptif untuk Anda.",
    icon: TrendingUp,
    colSpan: "md:col-span-4",
  ...
  {
    name: "EchoForum",
    description: "Diskusi inklusif & suportif.",
    icon: Users,
    colSpan: "md:col-span-4",
    ...
    <div className="min-h-screen relative font-sans selection:bg-primary/20 overflow-x-hidden">
      ...
      <section ref={targetRef} className="relative pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto min-h-[90vh] flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            >
              Hope.Ai menggunakan kecerdasan buatan untuk menciptakan pengalaman belajar yang 
              <span className="text-primary font-semibold"> inklusif</span>, 
              <span className="text-secondary font-semibold"> menyenangkan</span>, dan 
              <span className="text-accent font-semibold"> mudah diakses</span> oleh semua siswa.
            </motion.p>
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
              className="flex items-center gap-6 mt-10 text-sm font-medium text-muted-foreground justify-center md:justify-start"
            >
      ...
      <section id="features" className="px-4 md:px-8 py-20 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Fitur <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Luar Biasa</span>
          </motion.h2>
          <motion.p 
            variants={{
              hidden: { opacity: 0 },
          ...
          >
            Teknologi AI canggih dirancang khusus untuk kebutuhan belajar setiap anak.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(200px,auto)]">
          {features.map((feature, index) => (
            <motion.div
              ...
              className={`${feature.colSpan} group relative cursor-pointer`}
              onClick={() => navigate("/auth")}
            >
              <div className={`
